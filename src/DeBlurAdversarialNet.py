class DeBlurAdversarialNet:
    ...
    def train_model(self, epochs,
        ...
        ################################################################################################################
        loss_function = DeBlurAdversarialNet.__loss_function
        optimizer = DeBlurAdversarialNet.__optimizer(lr=0.001)
    ...
    def load_checkpoint(self, path_weights_load):
        ...
        try:
            self.__model = load_model(path_weights_load, custom_objects={"__loss_function": DeBlurAdversarialNet.__loss_function})
        except Exception as e:
            print(e)
    ...
    def __predict_from_image(self, image):
        ...
        import numpy as np
        prediction = self.__model.predict(DeBlurAdversarialNet.pre_process(np.expand_dims(image, axis=0)))
    ...
    def __predict_from_images(self, images):
        ...
        import numpy as np
        prediction = self.__model.predict(DeBlurAdversarialNet.pre_process(np.array(images)))
